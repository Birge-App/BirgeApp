...
abstract class HelpScreenStrings {
  ...
  static const helloText =
      'Меня зовут - Айман!\nЯ работаю в подходе рилив-терапии. Это сравнительно новое направление в психологическом консультировании и немедицинской психотерапии.\nРада с тобой познакомится, жду не дождусь узнать тебя по ближе.';
  static const therapist = 'О нашем психологе:';
  static const therapistAbout =
      'Название "рилив" происходит от английского и буквально переводится как "вновь пережить". Собственно, именно этот принцип является основой рилив-терапии: поднять, оживить события из прошлого и пережить их заново, с совершенно новых позиций. Это и помогает решить проблемы клиента на концептуальном уровне.\n\nРилив-терапия вобрала в себя и преобразовала самые успешные техники из различных психотерапевтических направлений: психоанализа, трансактного анализа, КПТ, телесно ориентированной терапии, гештальт-терапии, арт терапии и др.';
